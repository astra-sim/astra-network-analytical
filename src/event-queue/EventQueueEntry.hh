...
namespace AnalyticalBackend {
    ...
    public:
         ...
         */
        explicit EventQueueEntry(AstraSim::timespec_t time_stamp) noexcept: time_stamp(time_stamp) {}
         ...
         */
        static int compare_time_stamp(AstraSim::timespec_t time_stamp_a, AstraSim::timespec_t time_stamp_b) noexcept;
