...
bool EmitterState::SetOutputCharset(
    EMITTER_MANIP value,
...
bool EmitterState::SetBoolLengthFormat(
    EMITTER_MANIP value,
    FmtScope::value scope) {
  switch (value) {
    case LongBool:
...
bool EmitterState::SetPreCommentIndent(
    std::size_t value,
    FmtScope::value scope) {
  if (value == 0)
    return false;
...
bool EmitterState::SetPostCommentIndent(
    std::size_t value,
    FmtScope::value scope) {
  if (value == 0)
    return false;
...
bool EmitterState::SetDoublePrecision(
    std::size_t value,
    FmtScope::value scope) {
